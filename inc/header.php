 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand me-5 fe-bold fs-3 h-font" href="index.php">LOCKWOOD HOTEL</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-2 me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link me-3" href="gallery.php">Gallery</a>
                    </li>
                    <li class="nav-item ">
                ...
                <form>
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control shodow-none">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Password</label>
                            <input type="password" class="form-control shodow-none">
                        </div>
            ...
            <div class="modal-content">
                <form>
                    ...
                    <div class="modal-body">
                        ...
                        <span class="badge bg-light text-dark mb-3 text-wrap lh-base ">Note: Your details should match
                            your ID that will be required during check-in </span>
                        <div class="container-fluid">
                            <div class="row">
